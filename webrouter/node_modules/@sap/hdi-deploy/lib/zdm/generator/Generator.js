...
Generator.prototype.getArtifactPaths = function() {
    ...
    var cnt = content(options.root, services, options.workingSet, options.deployDirs, contentPathsFilter, options.stripCRFromCSV);
    ...
    async.series([ 
        function(cb) {
            ...
            if (model.existsDefaultAccessRole()) {
                // Commented until final decision is taken for generation of default_access_role.hdbrole to data and access containers
