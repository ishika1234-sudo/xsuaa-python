...
Task.prototype.invalidatePathFilters = function(options) {
    options.workingSet = filters.invalidPathFilter();
    options.includeFilter = filters.invalidPathFilter();
    options.deploy = filters.invalidPathFilter();
    options.undeploy = filters.invalidPathFilter();
};
