...
var dynamicRoutingUtils = require('./lib/utils/dynamic-routing-utils');
...
Approuter.prototype.createRouterConfig = function (options, callback) {
  ...
  try {
    ...
    var customDestinations = (options.destinations) ? envConfig.loadDestinations(options.destinations) : routerConfig.destinations;
    var customAppConfig = appConfig.loadConfiguration(routerConfig.workingDir,
      options.xsappConfig, customDestinations, xsappname);
    customAppConfig.logout = _.extend({}, routerConfig.appConfig.logout, _.pick(customAppConfig.logout, 'logoutPage','logoutEndpoint'));
