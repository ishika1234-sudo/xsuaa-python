...
function createBackendConnection(req, cb) {
  ...
  handleTokenExchange(req,function (err) {
    ...
    try {
      ...
      var protocols = req.headers && req.headers['sec-websocket-protocol'] ? req.headers['sec-websocket-protocol'] : null;
...
function addRouterConfig(req,cb){
  if (!dynamicRoutingUtils.isDynamicRouting() || (req.dynamicRouting && !req.dynamicRouting.routerConfig)){
